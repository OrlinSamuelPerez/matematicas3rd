...
export default async function  VerdaderoYFalsoAnalisis( idDeSubTema, repuesta, pregunta,Nivel, numeroPregunta, numero ){
    const data = []
    auth.onAuthStateChanged(async user=>{
       
        if(user != null){
            const subtemaTipo = (`Verdaderoyfalso-${idDeSubTema}`)
